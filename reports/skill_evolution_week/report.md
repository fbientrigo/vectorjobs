...
## Command
`jobsrec skill-evolution --input data\silver\jobs.parquet --outdir reports\skill_evolution --bin W --top-n 12 --max-rows 10000 --random-state 42 --confidence-threshold 0.05 --margin-threshold 0.01`
...
- Only 3 months are available; this is a temporal comparison, not a stable trend.
