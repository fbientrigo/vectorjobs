...
\begin{frame}{Estado actual --- madurez M2.3}
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      \textbf{Hecho}
      \begin{itemize}
        \item Clusters fijos (k=12) con centroides mensuales.
  ...
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        ...
        \item Calculamos centroides \textbf{por mes} y medimos la
              \textbf{deriva} (distancia coseno entre meses).
...
\begin{frame}{El eje salarial en los datos}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      \footnotesize Cobertura de salario por mes (solo $\sim$29\% de las filas).
    \end{column}
    \begin{column}{0.5\textwidth}
      \centering
